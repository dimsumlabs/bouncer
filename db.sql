...
CREATE TABLE "Users" (
  ...
  "name" varchar(64) DEFAULT NULL COLLATE NOCASE
);
...
CREATE TABLE "Groups" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  "email" varchar(64) NOT NULL COLLATE NOCASE,
  "group" varchar(32) NOT NULL COLLATE NOCASE,
  "count" int(11) NOT NULL DEFAULT 0
);
DROP INDEX IF EXISTS "IDX_Groups_EMAIL_GROUP";
CREATE UNIQUE INDEX "IDX_Groups_EMAIL_GROUP" ON "Groups"("email","group");
